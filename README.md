...
> The same system that runs a real web design agency, now with 527 production skills extracted from a live 7-agent fleet.
...
[![Skills](https://img.shields.io/badge/Skills-527%20production-DFB771?style=for-the-badge)](skills/INDEX.md)
...
- **527 production skills** extracted from the live Appie fleet (Mac Mini, GPU/media workers, VPS nodes, and approved client-bot hosts). Up from 156 in v4.4.
...
527 public skills across 9 categories. Each category has its own index.
...
527 ready-to-drop-in skills across 9 categories. The full skill library from the live fleet is larger; this kit contains the skills that transfer cleanly to any Hermes or OpenClaw setup.
...
├── skills/             # 527 public skills, 9 categories
...
- [Skills Catalog](SKILLS.md): browse 527 skills by category
