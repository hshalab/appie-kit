...
```yaml
project_context:
  # Use AI to generate smart summaries (requires OpenClaw)
  ai_summary: true
...
## AI Mode Setup (OpenClaw)

AI summaries require [OpenClaw](https://github.com/openclaw/openclaw) with the HTTP API enabled:
...
The script reads your gateway config from `~/.openclaw/openclaw.json` automatically.
